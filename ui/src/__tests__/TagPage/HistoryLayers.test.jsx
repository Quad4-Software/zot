...
describe('Artifact files display', () => {
  it('renders "Layers" title for artifact manifests', async () => {
    render(<HistoryLayers name="hello-artifact:v1" history={[]} isArtifact layers={mockArtifactLayers} />);
  ...
  it('shows "No artifact files available" when artifact has no layers', async () => {
    render(<HistoryLayers name="hello-artifact:v1" history={[]} isArtifact layers={[]} />);
